    ...
    <>
      <div className="scroll w-full max-h-[300px] overflow-y-scroll overflow-x-hidden !py-3 !px-4">
        <div className="cartItem w-full flex items-center gap-4 border-b border-[rgba(0,0,0,0.1)] !pb-4">
          <div className="img w-[25%] overflow-hidden ">
            <Link to={"/productDetails"} className="block group">
              <img
          ...
          <div className="info w-[75%] !pr-5 !relative">
            <h4 className="text-[14px] font-[500]">
              <Link to={"/productDetails"} className="link transition-all">
                Men Opaque Casual Shirt
              </Link>
            </h4>
            <p className="flex items-center gap-2 !mt-2 !mb-2">
      ...
      <div className="bottomSec absolute bottom-[10px] left-[10px] w-full overflow-hidden !pr-5">
        <div
          className="bottomInfo !py-3 !px-4 w-full !border-t border-[rgba(0,0,0,0.1)] flex
       ...
       items-center justify-between !flex-col"
        ...
        <div className="flex items-center justify-between w-full gap-5">
          ...
          <Link to={"/checkout"} className="w-[50%] d-block">
            <Button className="btn-org btn-border btn-lg w-full">Check Out </Button>
          </Link>
        </div>
      </div>
    </>
