      ...
      <div className="container flex !gap-5">
        ...
        <div className="rightCol w-[30%]">
          <div className="card !shadow-md bg-white !p-5 !rounded-md">
            ...
            <div className="!mb-5 scroll max-h-[250px] overflow-y-scroll overflow-x-hidden !pr-2">
              <div className="flex items-center justify-between !py-2">
                <div className="part1 flex items-center gap-3">
                  ...
                  <div className="info">
                    <h4 className="text-[14px]">FLORES Stylish Fashi... </h4>
                    <span className="text-[13px]">Qty : 1</span>
                  </div>
                </div>

                <span className="text-[14px]">₹1,550.00</span>
              </div>
            ...
            <Button className="btn-org btn-lg w-full flex gap-2 items-center"><BsBagCheckFill className="text-[20px]"/>Check Out</Button>
          </div>
        </div>
      </div>
    </section>
